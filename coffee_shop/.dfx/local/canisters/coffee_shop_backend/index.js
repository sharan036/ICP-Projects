...
import { idlFactory } from './coffee_shop_backend.did.js';
export { idlFactory } from './coffee_shop_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.COFFEE_SHOP_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./coffee_shop_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the coffee_shop_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./coffee_shop_backend.did.js")._SERVICE>}
 */
export const coffee_shop_backend = createActor(canisterId);
